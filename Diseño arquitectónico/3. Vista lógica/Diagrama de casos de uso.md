...
Un **diagrama de clases** es un tipo de diagrama estático en la Programación Orientada a Objetos (POO) que modela la estructura de un sistema mostrando:
 ...
 1. **Clases:**  Representan las entidades o conceptos del sistema (ej. `Postulante`, `Oferta`).<br>
 2. **Atributos:**  Definen las características o propiedades de cada clase (ej. `nombreCompleto`, `titulo`).<br>
 3. **Métodos:** Especifican los comportamientos o acciones que puede realizar la clase (ej. `publicarOferta()`).<br>
